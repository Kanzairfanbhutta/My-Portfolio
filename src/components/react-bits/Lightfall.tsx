...
vec3 palette(float h) {
  ...
  int idx = int(floor(clamp(h, 0.0, 0.999999) * count));
...
export function Lightfall({
  ...
  useEffect(() => {
    ...
    const renderer = new Renderer({
      ...
      alpha: false, // Disable alpha transparency to prevent stack layout blending issues
      antialias: true
    });
